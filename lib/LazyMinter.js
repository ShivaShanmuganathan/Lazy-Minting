 ...
 * @property {address} recipient the minimum price (in wei) that the creator will accept to redeem this NFT
...
class LazyMinter {
   ...
   * @param {address} recipient the minimum price (in wei) that the creator will accept to redeem this NFT. defaults to zero
   * 
   * @returns {NFTVoucher}
   */
  async createVoucher(tokenId, uri, recipient) {
    const voucher = { tokenId, uri, recipient }
